...
- [Code map](design/diagrams/omni-code-map.svg) -- the CLI's own real call
  graph, generated by `omni graph build` against this repo and rendered
  from that JSON, not hand-drawn
